...
SCENARIOS = [
    ...
    ("OB-32 cv_1979484122a8: '200 ke bajaye mera 300 … ka tha' (no deduction verb) -> both figures kept, nothing re-asked", [
        ("Haan bol raha hoon", [(TR, "n_ask_explained")]),
        ("Haan mujhe bataya gaya tha ki anurodhan fee jo hai do sau rupaya katega Aur do sau ke bajaye mera teen sau rupaye onloading fees ka tha",
         [(SL, '"deduction_explained": "yes"'), (SL, '"amount_informed": "yes"'),
          (SL, '"informed_amount": "200"'), (SL, '"deducted_amount": "300"'),
          (SL, '"amount_matches": "no"'), (TR, "n_msg_amounts_differ"),
          (RN, Q2), (RN, Q2B), (RN, Q3), (RN, Q_DED), (R, Q_WEEK)]),
        ("Ye last Tuesday ko hua tha", [(TR, "n_hub_verify"), (R, "200"), (R, "300"), (R, "100 रुपये का difference")]),
        ("Haan sab sahi hai", [(SL, '"verification_status": "amount_mismatch"'), (RN, "consistent")]),
        ("nahi", MOCKS, [(DN, "true"), (SM, '"informed_amount": "200"'),
                         (SM, '"deducted_amount": "300"'), (SM, '"amount_matches": "no"')]),
    ]),
    ("OB-33 contrast variants (ki jagah / Devanagari / English instead-of) -> figures captured, week asked next", [
        ("haan", [(TR, "n_ask_explained")]),
        ("haan bataya tha, do sau ki jagah teen sau kat gaya",
         [(SL, '"informed_amount": "200"'), (SL, '"deducted_amount": "300"'), (SL, '"amount_matches": "no"'),
          (RN, Q3), (RN, Q_DED), (R, Q_WEEK)]),
    ]),
    ("OB-33b Devanagari contrast", [
        ("haan", [(TR, "n_ask_explained")]),
        ("हाँ बताया था, दो सौ के बजाय मेरा तीन सौ कटा।",
         [(SL, '"informed_amount": "200"'), (SL, '"deducted_amount": "300"'), (SL, '"amount_matches": "no"'),
          (RN, Q3), (RN, Q_DED), (R, Q_WEEK)]),
    ]),
    ("OB-33c English contrast", [
        ("yes", EN, [(TR, "n_ask_explained")]),
        ("Yes, they told me. Instead of 200 they took 300 from my payout.", EN,
         [(SL, '"informed_amount": "200"'), (SL, '"deducted_amount": "300"'), (SL, '"amount_matches": "no"'),
          (RN, "the same as the amount you were told"), (RN, "how much was deducted"), (R, "week")]),
    ]),
    ("OB-33e 'told, 300 instead of 200' -> contrast beats the generic told-figure capture", [
        ("yes", EN, [(TR, "n_ask_explained")]),
        ("yes I was told, 300 instead of 200", EN,
         [(SL, '"informed_amount": "200"'), (SL, '"deducted_amount": "300"'), (SL, '"amount_matches": "no"'),
          (RN, "the same as the amount you were told"), (RN, "how much was deducted"), (R, "week")]),
    ]),
    ("OB-34 cv_3c3e42bd6519: confirmed readback (200/500/Monday) -> outcome without re-reading the figures", [
        ("haan", [(TR, "n_ask_explained")]),
        ("haan bataya tha, 200 katega bola tha, lekin 500 kata",
         [(SL, '"informed_amount": "200"'), (SL, '"deducted_amount": "500"'), (R, Q_WEEK)]),
        ("Monday ko", [(TR, "n_hub_verify"), (R, "200"), (R, "500"), (R, "300 रुपये का difference"), (R, VERIFY_HI)]),
        ("Haan sahi hai", [(TR, "n_cond_out_informed_2"), (TR, "n_msg_mismatch"), (TR, "n_hub_more"),
                           (TN, "n_ask_correction"), (SL, '"verification_status": "amount_mismatch"'),
                           (RN, "200"), (RN, "500"), (RN, "300"), (RN, "दो सौ"), (RN, "पांच सौ"), (RN, "पाँच सौ"),
                           (RN, "तीन सौ"), (RN, VERIFY_HI), (R, MORE)]),
        ("nahi", MOCKS, [(DN, "true"), (SM, '"informed_amount": "200"'), (SM, '"deducted_amount": "500"'),
                         (SM, '"verification_status": "amount_mismatch"')]),
    ]),
    ("OB-34b confirmed readback, English caller -> outcome without figures", [
        ("yes", EN, [(TR, "n_ask_explained")]),
        ("Yes, I was told 200 but 500 was deducted", EN, [(SL, '"deducted_amount": "500"'), (R, "week")]),
        ("last Monday", EN, [(TR, "n_hub_verify"), (R, "correct")]),
        ("yes, that's correct", EN, [(TR, "n_msg_mismatch"), (TR, "n_hub_more"), (RN, "200"), (RN, "500"), (RN, "300"),
                                     (RN, "two hundred"), (RN, "five hundred"), (RN, "is all of this correct")]),
    ]),
    ("OB-34c rejected readback -> correction ask, no outcome", [
        ("haan", [(TR, "n_ask_explained")]),
        ("haan bataya tha, 200 katega bola tha, lekin 500 kata", [(R, Q_WEEK)]),
        ("Monday ko", [(TR, "n_hub_verify")]),
        ("nahi galat hai", [(TR, "n_ask_correction"), (TN, "n_msg_mismatch"), (R, "कौन सी बात सही नहीं है"),
                            (SLN, '"verification_status"')]),
    ]),
    ("OB-33d a question about values with the same wording fills nothing", [
        ("haan", [(TR, "n_ask_explained")]),
        ("kya 200 ke bajaye 300 kat sakta hai?",
         [(SLN, '"informed_amount"'), (SLN, '"deducted_amount"'), (SLN, '"amount_matches"')]),
    ]),

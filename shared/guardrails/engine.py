...
# Malayalam / Tamil renderings, merged at import (plain locale lookup).
_GUARDRAIL_PHRASES_ML_TA: dict[str, dict[str, str]] = {
    "guardrail_blocked": {
        "ml": "ക്ഷമിക്കണം, ഈ കോളിൽ അതിൽ എനിക്ക് സഹായിക്കാൻ കഴിയില്ല. മറ്റെന്തെങ്കിലും സഹായം വേണോ?",
        "ta": "மன்னிக்கவும், இந்த அழைப்பில் அதற்கு என்னால் உதவ முடியாது. வேறு ஏதாவது உதவி வேண்டுமா?",
    },
    "guardrail_payment": {
        "ml": ("നിങ്ങളുടെ സുരക്ഷയ്ക്കായി, ഈ കോളിൽ കാർഡ് നമ്പർ, OTP അല്ലെങ്കിൽ പാസ്‌വേഡ് ഒരിക്കലും "
               "പറയരുത് — അവ എനിക്ക് സ്വീകരിക്കാൻ കഴിയില്ല. മറ്റെന്തെങ്കിലും സഹായം വേണോ?"),
        "ta": ("உங்கள் பாதுகாப்பிற்காக, இந்த அழைப்பில் கார்டு எண், OTP அல்லது கடவுச்சொல்லை ஒருபோதும் "
               "சொல்ல வேண்டாம் — அவற்றை என்னால் ஏற்க முடியாது. வேறு என்ன உதவி வேண்டும்?"),
    },
    "guardrail_medical": {
        "ml": ("രോഗനിർണ്ണയമോ മരുന്നിന്റെ അളവോ പോലുള്ള വൈദ്യോപദേശം എനിക്ക് നൽകാൻ കഴിയില്ല. "
               "അതിനായി നിങ്ങളെ ഞങ്ങളുടെ സ്റ്റാഫുമായി ബന്ധിപ്പിക്കാം. മറ്റെന്തെങ്കിലും സഹായം വേണോ?"),
        "ta": ("நோய் கண்டறிதல் அல்லது மருந்தளவு போன்ற மருத்துவ ஆலோசனை என்னால் வழங்க முடியாது. "
               "அதற்காக உங்களை எங்கள் ஊழியர்களுடன் இணைக்கலாம். வேறு ஏதாவது உதவி வேண்டுமா?"),
    },
    "guardrail_booking": {
        "ml": ("ബുക്കിംഗ്, റീഫണ്ട് അല്ലെങ്കിൽ അപ്‌ഗ്രേഡ് എനിക്ക് സ്വയം ഉറപ്പുനൽകാൻ കഴിയില്ല. അത് സ്ഥിരീകരിക്കാൻ "
               "കഴിയുന്ന ഞങ്ങളുടെ റിസർവേഷൻ ടീമുമായി നിങ്ങളെ ബന്ധിപ്പിക്കാം. മറ്റെന്തെങ്കിലും സഹായം വേണോ?"),
        "ta": ("புக்கிங், ரீஃபண்ட் அல்லது அப்கிரேடை நானே உறுதியளிக்க முடியாது. அதை உறுதிப்படுத்தக்கூடிய "
               "எங்கள் ரிசர்வேஷன் குழுவுடன் உங்களை இணைக்கிறேன். வேறு ஏதாவது உதவி வேண்டுமா?"),
    },
    "guardrail_waiver": {
        "ml": ("ഇളവ്, ഡിസ്കൗണ്ട് അല്ലെങ്കിൽ സെറ്റിൽമെന്റ് എനിക്ക് സ്വയം അംഗീകരിക്കാൻ കഴിയില്ല. "
               "അത് പരിശോധിക്കാൻ കഴിയുന്ന ഞങ്ങളുടെ ടീമുമായി നിങ്ങളെ ബന്ധിപ്പിക്കാം."),
        "ta": ("தள்ளுபடி, சலுகை அல்லது செட்டில்மெண்டை நானே அங்கீகரிக்க முடியாது. "
               "அதைப் பரிசீலிக்கக்கூடிய எங்கள் குழுவுடன் உங்களை இணைக்கிறேன்."),
    },
}
for _key, _extra in _GUARDRAIL_PHRASES_ML_TA.items():
    _GUARDRAIL_PHRASES.setdefault(_key, {}).update(_extra)

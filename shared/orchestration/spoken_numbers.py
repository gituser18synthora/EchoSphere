...
_MAGNITUDES = {
    ...
    # Malayalam / Tamil magnitudes ("രണ്ട് ആയിരം", "ஐந்து நூறு"); romanizations
    # that collide with nothing common in Hindi/English speech.
    "നൂറ്": 100, "നൂറു": 100, "ആയിരം": 1000, "ലക്ഷം": 100_000, "കോടി": 10_000_000,
    "நூறு": 100, "ஆயிரம்": 1000, "லட்சம்": 100_000, "கோடி": 10_000_000,
    "nooru": 100, "aayiram": 1000, "ayiram": 1000, "laksham": 100_000, "latcham": 100_000,
}

# Malayalam / Tamil amounts are usually ONE fused word ("രണ്ടായിരം" = 2000,
# "இரண்டாயிரம்" = 2000, "അഞ്ഞൂറ്" = 500) — listed as compounds so the
# deterministic amount matchers see the same digits a Hindi "दो हज़ार" yields.
_ML_TA_COMPOUND = {
    # Malayalam tens / hundreds / thousands
    "പത്ത്": 10, "പതിനഞ്ച്": 15, "ഇരുപത്": 20, "മുപ്പത്": 30, "നാല്പത്": 40, "നാൽപത്": 40,
    "അമ്പത്": 50, "അറുപത്": 60, "എഴുപത്": 70, "എൺപത്": 80, "തൊണ്ണൂറ്": 90,
    "ഇരുനൂറ്": 200, "മുന്നൂറ്": 300, "നാനൂറ്": 400, "അഞ്ഞൂറ്": 500, "അറുനൂറ്": 600,
    "എഴുനൂറ്": 700, "എണ്ണൂറ്": 800, "തൊള്ളായിരം": 900,
    "രണ്ടായിരം": 2000, "മൂവായിരം": 3000, "നാലായിരം": 4000, "അയ്യായിരം": 5000, "അഞ്ചായിരം": 5000,
    "ആറായിരം": 6000, "ഏഴായിരം": 7000, "എണ്ണായിരം": 8000, "ഒമ്പതിനായിരം": 9000,
    "പതിനായിരം": 10000, "ഇരുപതിനായിരം": 20000, "മുപ്പതിനായിരം": 30000, "അമ്പതിനായിരം": 50000,
    # Tamil tens / hundreds / thousands
    "பத்து": 10, "பதினைந்து": 15, "இருபது": 20, "முப்பது": 30, "நாற்பது": 40, "ஐம்பது": 50,
    "அறுபது": 60, "எழுபது": 70, "எண்பது": 80, "தொண்ணூறு": 90,
    "இருநூறு": 200, "முந்நூறு": 300, "நானூறு": 400, "ஐந்நூறு": 500, "ஐநூறு": 500, "அறுநூறு": 600,
    "எழுநூறு": 700, "எண்ணூறு": 800, "தொள்ளாயிரம்": 900,
    "இரண்டாயிரம்": 2000, "ரெண்டாயிரம்": 2000, "மூவாயிரம்": 3000, "நாலாயிரம்": 4000, "ஐயாயிரம்": 5000,
    "ஐந்தாயிரம்": 5000, "ஆறாயிரம்": 6000, "ஏழாயிரம்": 7000, "எண்ணாயிரம்": 8000, "ஒன்பதாயிரம்": 9000,
    "பத்தாயிரம்": 10000, "இருபதாயிரம்": 20000, "முப்பதாயிரம்": 30000, "ஐம்பதாயிரம்": 50000,
    # Romanized forms heard in transliterated STT output
    "randayiram": 2000, "rendayiram": 2000, "irandayiram": 2000, "anjooru": 500, "ainooru": 500,
    "aiyayiram": 5000, "anjayiram": 5000, "pathayiram": 10000, "pathinayiram": 10000,
}
...
_MULTI_DIGIT.update(_ML_TA_COMPOUND)

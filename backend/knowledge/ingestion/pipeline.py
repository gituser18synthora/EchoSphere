...
from backend.knowledge.models import IngestionJob, KnowledgeDocument
from backend.knowledge.schemas import ChunkPayload
from backend.knowledge.security import detect_prompt_injection
...
class IngestionPipeline:
    ...
    async def _run_stages(
        ...
        *,
        ...
        from backend.knowledge.parsing.loader import load_document

...
These adapters let the same tenant/bot-selectable providers (backend.providers)
...
from backend.providers.base import ProviderError, STTProvider, TTSProvider
from backend.voice_runtime.audio.pcm import wav_to_pcm

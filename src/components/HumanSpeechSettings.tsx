...
const NUMBER_FIELDS: {
  ...
  { key: "latency_filler_hmm_ms", label: "Ladder \"hmm\" cue at (ms)", min: 2000, max: 8000, step: 100, help: "Time after the caller stops before the voiced \"Hmm…\" cue may play, when the reply still has not started." },
